        ...
        <div class="container">
          <div class="footer__grid">
            <div class="footer__brand">
              ...
              <p>Full Stack Developer • UI/UX Designer • Creative Developer. Building modern web applications and thoughtful digital experiences from Sri Lanka.</p>
            </div>
            ...
            <div class="footer__col">
              <h4>Social</h4>
              <ul>
                <li><a href="https://github.com/SIRATHNAYAKA" target="_blank" rel="noopener"><span data-icon="github"></span> GitHub</a></li>
                <li><a href="[REPLACE WITH YOUR LINKEDIN URL]" target="_blank" rel="noopener"><span data-icon="linkedin"></span> LinkedIn</a></li>
                <li><a href="[REPLACE WITH YOUR FACEBOOK URL]" target="_blank" rel="noopener">Facebook</a></li>
                <li><a href="[REPLACE WITH YOUR INSTAGRAM URL]" target="_blank" rel="noopener">Instagram</a></li>
              </ul>
            </div>

            <div class="footer__col">
              <h4>Creative Brand</h4>
              <ul>
                <li><a href="index.html#studio">BLACK STUDIO</a></li>
                <li><a href="services.html">Services</a></li>
                <li><a href="assets/downloads/Sachin-Rathnayaka-CV.pdf" download>Download CV</a></li>
              </ul>
            </div>
          </div>
          ...
          <div class="footer__bottom">
            ...
            <p>Crafted with care • <a href="index.html#home">Back to top</a></p>
          </div>
        </div>
      </footer>
    `;
